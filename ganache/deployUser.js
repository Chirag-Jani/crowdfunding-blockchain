...
const compiledUserContract = require("./build/UserContract.json");
...
const deploy = async () => {
  try {
    ...
    const Contract = await new web3.eth.Contract(compiledUserContract.abi)
      .deploy({ data: compiledUserContract.evm.bytecode.object })
